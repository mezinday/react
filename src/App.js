...
import letterList from "./Page/LetterList";
import privateLetterList from "./Page/PrivateLetterList";
      ...
      <Container>
        <Store>
          <Switch>
            ...
            <Route path="/letterList" exact component={letterList} />
            <PrivateRoute path="/letterForMezin" component={Sub6} />
            <Route path="/login" exact component={Login} />
            <Route path="/babo" exact component={Babo} />
            <PrivateRoute
              path="/privateLetterList"
              component={privateLetterList}
            />
            <Redirect to="/main" />
          </Switch>
        </Store>
